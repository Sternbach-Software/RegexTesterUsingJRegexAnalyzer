...
//        jApplyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconReload.png"))); // NOI18N
        ...
        jModeSelector.setModel(new DefaultComboBoxModel(new String[] { "find", "match" }));
...
//        jMLEditButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconEdit.png"))); // NOI18N
        ...
        jMLEditButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
//        jToLiteralButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconToLiteral.png"))); // NOI18N
        ...
        jToLiteralButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
//        jImportRecentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconImportRecent.png"))); // NOI18N
        ...
        jImportRecentButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
//        jPatternDotButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconDot.png"))); // NOI18N
        ...
        jPatternDotButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
//        jPreferencesButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconPreferences.png"))); // NOI18N
        ...
        jPreferencesButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
//        jAboutButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/schwebke/jregexanalyser/res/IconAbout.png"))); // NOI18N
        ...
        jAboutButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void jImportButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jImportButtonActionPerformed
    ...
    private void jPreferencesButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jPreferencesButtonActionPerformed
        if (prefDialog == null) {
    ...
    private void jAboutButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jAboutButtonActionPerformed
        JOptionPane.showMessageDialog(
                this,
                Main.about,
                Main.version,
    ...
    private void jHelpButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jHelpButtonActionPerformed
    ...
    private void jExitButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jExitButtonActionPerformed
        setVisible(false);
        dispose();
    }//GEN-LAST:event_jExitButtonActionPerformed

    private void jMLEditButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMLEditButtonActionPerformed
        // create edit window
        if (regExEdit == null) {
    ...
    private void jClearButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jClearButtonActionPerformed
        regExInputModel.removeAllElements();
        jRegExInput.setEditable(true);
    ...
    private void jToLiteralButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jToLiteralButtonActionPerformed
    ...
    private void jPatternDotButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jPatternDotButtonActionPerformed
    ...
    private void jNewButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jNewButtonActionPerformed
    ...
    private void jImportRecentButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jImportRecentButtonActionPerformed
    ...
    private void jMatchTraceTableListSelectionChanged(ListSelectionEvent e) {
        ...
        if (Statistics.TraceTableModel.class.isInstance(tableModel)) {
            ...
            Statistics.MatchTest mt = ttm.getMatchTest(row);
            if (mt == null) {
                return;
            }
    ...
    // manual GUI elements
    private JPopupMenu jRecentTestTextPopup;
